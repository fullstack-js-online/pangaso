...
var Action = /** @class */ (function () {
     ...
     *
     */
    Action.prototype.handle = function (databaseConnection, request, resources) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve({ databaseConnection: databaseConnection, request: request, resources: resources })];
            });
        });
    };
    /**
     ...
     *
     */
    Action.prototype.as = function (name) {
        this.name = name;
        return this;
    };
    return Action;
